...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                          ...
                          children: [
                            ...
                            if (notifier.totalIncome > 0 &&
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppTheme.glowingRed.withValues(
                                    alpha: 0.15,
                                  ),
                              ...
                              children: [
                                Expanded(
                                  child: _summaryChip(
                                    context,
                                    'INCOME',
                                    '₹${notifier.totalIncome.toStringAsFixed(0)}',
                                    AppTheme.accentCyan,
                                    Icons.trending_up,
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: _summaryChip(
                                    context,
                                    'EXPENSE',
                                    '₹${notifier.totalExpense.toStringAsFixed(0)}',
                                    AppTheme.glowingRed,
                                    Icons.trending_down,
                                  ),
                                ),
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: isIncome
                                            ...
                                            : AppTheme.glowingRed.withValues(
                                                alpha: 0.1,
                                              ),
                                        shape: BoxShape.circle,
                                      ),
      ...
      floatingActionButton: Container(
        ...
        decoration: BoxDecoration(
          color: (isDark ? AppTheme.surface : Colors.white).withValues(
            alpha: 0.95,
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text(
                'Modify title, amount, or category',
            ...
            ListTile(
              ...
              title: const Text(
                'Delete Transaction',
                style: TextStyle(color: AppTheme.glowingRed),
              ),
              subtitle: const Text(
  ...
  List<FlSpot> _buildSpots(List transactions) {
    ...
    for (int i = 0; i < reversedTx.length && i < 10; i++) {
      runningBalance += reversedTx[i].type == 'income'
          ? reversedTx[i].amount
          : -reversedTx[i].amount;
